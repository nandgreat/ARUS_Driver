...
public class MechanicSuccess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanic_success);
        ...
        bHome.setOnClickListener(v -> {
            ...
            startActivity(new Intent(MechanicSuccess.this, HomeActivity.class));
            finish();
        });
