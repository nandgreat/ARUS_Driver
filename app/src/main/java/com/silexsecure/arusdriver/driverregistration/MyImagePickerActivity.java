...
public class MyImagePickerActivity extends AppCompatActivity {
    ...
    private static final String TAG = MyImagePickerActivity.class.getSimpleName();
    ...
    public static void showImagePickerOptions(Context context, final PickerOptionListener listener) {
        ...
        ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(Color.DKGRAY);
...
//                    handleUCropResult(data);
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(MyImagePickerActivity.this, getPackageName() + ".provider", image);
    }
